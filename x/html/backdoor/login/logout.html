<div class="container">
	...
	<h1 style="display: inline;">
			...
			<h4 style="display: inline;">{$login_message}</h4>	
	</div>
</div>
	...
	<tr>
		<td align="center" valign="top"  > 
			<div   style="text-align: center; width:600px;"> 
				...
				{$LANG.LOGIN.LOGOUT.SUCCESS} <br/> 
				<button onclick="history.back()" style="float: left" value="Connect" class="punch">
			 		<img src="{$ICON.32}arrow_left.png">
				</button> 
				<button onclick="location = location.origin" style="float: right;" value="Connect" class="punch">
			 		 <img src="{$ICON.32}www_page.png">
				</button>
				<img src="{$ICON.256}Logout.png" align="absmiddle" /> <br/>
 					{$LANG.LOGIN.LOGOUT.MSG} 
				</h4> 
...
background: url(data:image/svg+xml;base64,);
