...
background: linear-gradient(left, rgba(13,13,13,1) 1%,rgba(78,78,78,1) 40%,rgba(239,155,0,1) 42%,rgba(149,149,149,1) 44%,rgba(1,1,1,1) 49%,rgba(149,149,149,1) 54%,rgba(239,155,0,1) 56%,rgba(56,56,56,1) 58%,rgba(27,27,27,1) 100%); /* W3C */}
  ...
  .sign{
	...
	border-left-color: #ddd; 
	  ...
	  width: 25%;
	  margin:  5px 0 0 5px;
	-webkit-box-shadow: -50px -10px 10px rgba(0,0,0,0.5); 
	-webkit-border-radius: 15px; 
	  ...
	  .middleTilt{
	  -webkit-transform:rotate3d(0, 1, 0, 2deg) scale(1.001);
	...
	-webkit-box-shadow: 10px 20px 10px rgba(0,0,0,0.25);
...
<table id="nav-map" height="90%" align="center" width="90%" cellspacing="0" cellpadding="0" style="-webkit-perspective:300;">
	<tr style="">
		<td width="33%" align="center" class="leftTilt">
			SuperDom Core
			<table height="100%" width="100%" class="left" cellspacing="0" cellpadding="10">
				<tr>
					<td colspan=3 class="water" align="center" valign="middle"
						height="35%">
						<div>

							<!-- img align="absmiddle" src="{$phpThumb}w=48&src={$ICON.64}/core.png"/> -->
							<img align="absmiddle"
								src="{$phpThumb}w=200&src=/bin/images/logos/sdx.png" /> <img
								align="absmiddle" src="{$ICON.48}/Network radar.png" /> <span
								style="font-size: small"> v.1 </span>
						</div> <img src="{$ICON.48}/System.png" /> <img
						src="{$ICON.48}/Traffic cone.png" /> <img
						src="{$ICON.48}/basket.png" /> <img src="{$ICON.48}/float.png" />
						<img src="{$ICON.48}/Glasses.png" />
				...
				<tr>
					<td class="water" width="50%" valign="middle" align='center'>
						
					
						<img src="{$ICON.48}/Coffee I love NY.png"/>
						<img src="{$ICON.48}/Map.png"/>
						<img src="{$ICON.48}/earth.png"/> 
						<img src="{$ICON.48}/GPS.png"/>
					 
						<img src="{$ICON.48}/Sign direction.png"/>
						
						<img src="{$ICON.48}/MailFront.png"/>
						 <img src="{$ICON.48}/Ticket.png"/>
						<img src="{$ICON.48}/Box double tape.png"/>
						
					</td>
				</tr>
				<tr>
					<td colspan=3 class="roadH"> 
						 <div>
				...
				<tr>
					<td colspan=3 class="gravel" height="35%" align="center"> 
						
						
						
						
						<img src="{$ICON.48}/Diary.png"/>
						<img src="{$ICON.48}/News.png"/> 
						<img src="{$ICON.48}/USB.png"/>
					<img src="{$ICON.48}/cork.png"><img src="{$ICON.48}/Pictures.png"> 
						<img src="{$ICON.48}/MagnetRedBlue.png"/> 
					<img src="{$ICON.48}/controller.png"> 
						
						 
						<img src="{$ICON.48}/Streaming.png"/>
						 
					 	<img src="{$ICON.48}/Shop.png"><img src="{$ICON.48}/Chalkboard2.png"/>
		...
		<td width="33%"  class="middleTilt" align="center">
			Access Control
			<table height="100%" width="100%" class="left" cellspacing="0" cellpadding="10">
				<tr>
					<td rowspan=5 class="roadV" ><div></div></td> 
					<td height="35%"  class="grass"    valign="middle" align='center'>
						<img  src="{$ICON.48}/home.png"/>
						<img src="{$ICON.48}/Keychain2.png"/>
						<img src="{$ICON.48}/key.png"/>
						
						<img src="{$ICON.48}/database.png"/> <img src="{$ICON.48}/credit paypal.png"/>
						<img src="{$ICON.48}/Signal stop.png"/> 
					</td>
				...
				<tr>
					...
					<td class="water" align="center"  >
					
						<img src="{$ICON.48}/document_pen.png"/> 
						<img src="{$ICON.48}/blueprint3.png"/>
						
						<img src="{$ICON.48}/Electric socket 2.png"/>
						<img src="{$ICON.48}/Brushes.png"/>
				...
				<tr>
					<td  class="grass" height="35%" align="center">
						
					 	<img src="{$ICON.48}/onebit_24.png"/>
						<img src="{$ICON.48}/rss.png"/>
		...
		<td width="33%"  class="rightTilt" align="center">
			Networking
			<table height="100%" width="100%" class="left" cellspacing="0" cellpadding="10">
				<tr>
					<td rowspan=5 class="roadV" ><div></div></td> 
					
					 <td  height="35%" class="gravel"  align="center" valign='middle'>
					
					<img src="{$ICON.48}/Contacts2.png"/>
					
					<img src="{$ICON.48}/contacts.png"/>
					<img src="{$ICON.48}/book fb.png"/>
					<img src="{$ICON.48}/twitter_standing.png"/>
					
					<img src="{$ICON.48}/Cloud.png"/>
					<img src="{$ICON.48}/comments.png"/>
					
						<img src="{$ICON.48}/megaphone.gif"/>
					
					 
						
						  
					
					<img src="{$ICON.48}/metallic briefcase.png"/>
					
					<img src="{$ICON.48}/Gift.png"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td   class="water" align="center" >
							...
							<img src="{$ICON.48}/Zoom.png"/>
						<img src="{$ICON.48}/Bullseye.png"/>
						<img src="{$ICON.48}/anchor.png"/>
						<img src="{$ICON.48}/Safari.png"/>
						
						<img src="{$ICON.48}/star.png"/>
				...
				<tr>
					<td   class="grass" height="35%" align="center">
					 	...
					 	<img src="{$ICON.48}/presentation.png"/>
						<img src="{$ICON.48}/Calculator full.png"/>
...
<div id="sign-container" onclick="this.style.display = 'none'">
	<div class='poleleft'></div> 
	<div class='poleright'></div>
	<div class="sign" > 
		<span style="font-size:  small">Welcome to {$site_name}</span><br/> 
		{if $site_logo}<img align="absmiddle" src="{$phpThumb}h=50&src={$site_logo}"/><br/>{/if}
		{$HTTP_HOST}<br/>	
