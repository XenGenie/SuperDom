    ...
    <div class="tab-content">
        ...
        <div class="description">
            <ul class="pager wizard">
                <li class="previous">
                    <button class="btn btn-danger pull-left"><i class="fa fa-caret-left"></i> Previous</button>
                </li>
                <li class="next">
...
<script type="text/javascript" src="/x/html/layout/watchtower/lib/jquery.bootstrap.wizard.js"></script>
<!-- page specific js -->
