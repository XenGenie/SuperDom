	...
	<tr>
		<td align="center" valign="top"  > 
			<div id="deny-access" style="text-align: center; width:600px;"> 
				...
				<button onclick="window.location = window.location.origin+window.location.pathname.replace('/{$toBackDoor}','');" style="float: left" value="Connect" class="punch">
			 		<img src="{$ICON.32}life_vest.png">
				</button> 
				<button onclick="location =  window.location.origin+'/login/logout'" style="float: right;" value="Connect" class="punch">
			 		 <img src="{$ICON.32}exit.png">
				</button>
				<img src="{$ICON.256}Symbol-Stop.png" align="absmiddle" /> <br/>
 				Access Denied<br/>{$request|replace:'/html':''}<BR/>{$reason}
				</h4> 
